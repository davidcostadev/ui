...
/** @class */
function (_super) {
  tslib_es6.__extends(ReactCodeInput, _super);
  ...
  function ReactCodeInput(props) {
    ...
    _this.onKeyDown = function (e) {
      ...
      switch (e.keyCode) {
        case KEY_CODE.backspace:
          ...
          var vals = tslib_es6.__spreadArray([], tslib_es6.__read(_this.state.values), false);
    ...
    if (fields) {
      for (var i = 0; i < fields; i++) {
        _this.iRefs.push( /*#__PURE__*/React__default["default"].createRef());
      }
    }
...
exports.ReactCodeInput = ReactCodeInput;
